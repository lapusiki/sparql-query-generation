...
public class QueryBuilder {
    ...
    private final String QUERY_TEMPLATE_FANCY =
            new StringBuilder("PREFIX foaf: <http://xmlns.com/foaf/0.1/>").append("\n")
    ...
    public String build() throws Exception {
        ...
        switch (question.getType()) {
            ...
            case GET_VAR_QUESTION:
                ...
                break;
            default:
                throw new IllegalArgumentException("Пока не умею строить запросы для такого типа вопроса");
        }
